...
import {InputMaskDemo} from './inputmask';
...
// <Calendar tabindex="0" dateFormat="dd/mm/yy"
// onChange={this.onChangeBasic}></Calendar>{this.parseLocalDateString(this.state.date1)}
// </div>
